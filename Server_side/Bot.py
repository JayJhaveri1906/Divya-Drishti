...
class Bot:
    ...
    def __init__(self):
        # with open(
        #         "D:\\TP_PROGS\\Projects\\TeProjSahara\\progs\\Sahara-System-For-Aiding-Visually-Impaired-master\\Sahara-System-For-Aiding-Visually-Impaired-master\\Server_side\\DataFiles\\corpus.json",
        #         "r") as f:
        with open("DataFiles\\corpus.json", "r") as f:
            self.corpus = json.loads(f.read())
            """ word: intent"""
            self.intents = ("TotalCash", "Color", "BillReading", "TextSummarization", "BasicTextReading",
                            "DocumentClassification", "CurrencyRecognition", "Next", "Stop", "Object", "Mask",
                            "BusiCard", "Name", "Address", "Job title", "Company", "Website", "Email", "Phone", "Full")
            # List of features: Cash, total cash, color, bill, busiCard, text, summary, object, mask,
